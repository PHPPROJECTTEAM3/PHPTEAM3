    ...
    <div class="container" style="padding-bottom: 5%;padding-top: 0%;padding-left: 1%;">
        <div class="row">
            <div class="col-sm-4" style="padding-top: 10%;">
                <img width="50%" height="30%" src="../Images/Brand/samsung.jpg" style="
    margin-left: 25%;
    margin-bottom: 5%;
">
            ...
            <div class="col-sm-4" style="padding-top: 10%;">
                <img width="50%" height="30%" src="../Images/Brand/Apple.png" style="
    margin-left: 25%;
">
...
">
    ...
    <div class="container" style="padding-bottom: 10%;padding-left: 1%;">
        <div class="row" style="padding-bottom: 5%;
             ...
             ">
            <div class="col-sm-4" >
                <img width="50%" height="30%" src="../Images/Brand/Oppo.jpg" style="
    margin-left: 24%;
">
